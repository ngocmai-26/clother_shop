...
function AddressManager({ setAccountUser }) {
  ...
  return (
    <Layout>
      ...
      <div
        hidden={hidden}
        className="fixed top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden bg-zinc-400/25 overflow-y-auto md:inset-0 h-[calc(100%-0rem)] max-h-full"
      >
        <div className="relative w-full max-w-2xl max-h-full mx-auto mt-10">
