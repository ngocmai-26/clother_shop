          ...
          <div className="w-full  my-6 pr-0 lg:pr-2">
            <div className="leading-loose">
              <form className="p-10 bg-white rounded shadow-xl">
                <div>
                  <label className="block text-sm text-gray-600" for="txtCode">
                    {t("code_orders")}
                  </label>
                  <input
                ...
                <div className="mt-2">
                  <label className="block text-sm text-gray-600" for="txtName">
                    {t("name_product")}
                  </label>
                  <input
                    className="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded outline-0"
                ...
                <div className="mt-2">
                  <label className="block text-sm text-gray-600" for="txtPrice">
                    {t("price")}
                  </label>
                  <input
                    className="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded outline-0"
